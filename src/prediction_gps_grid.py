...
def training_lstm_grid(X_train, y_train, X_test, y_test, EXPERIMENT_PARAMETERS, max_s_index, MODEL_FILE, MODEL_WEIGHT_FILE_LSTM_GRID, FIGURE_DIR):
    ...
    # uni-directional
    lstm_1 = LSTM(hidden_neurons, return_sequences=True, dropout=0.2, recurrent_dropout=0.2, name='lstm-1')(embedding)
    ...
    # No dropout
    # lstm_1 = LSTM(hidden_neurons, return_sequences=True, name='lstm-1')(embedding)
