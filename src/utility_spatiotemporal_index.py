...
if __name__ == '__main__':
    ...
    # spatial_index_number = convert_raw_coordinates_to_spatial_index(EXPERIMENT_PARAMETERS, spatial_index, X_TEST, Y_TEST)
    # x, y = convert_spatial_index_to_raw_coordinates(EXPERIMENT_PARAMETERS, spatial_index, spatial_index_number)
    # print(x)
    # print(y)
    # convert_raw_coordinates_to_geohash(138.72, 34.9)
    # convert_geohas_to_raw_coordinates('xn4ws9')