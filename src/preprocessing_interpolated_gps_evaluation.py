...
def load_csv_to_dataframe(CSV_FILE):
    ...
    df_filtered = df_csv[(df_csv['time_end'] >= EXPERIMENT_PARAMETERS["EVALUATION_OBSERVATION_START"]) & (df_csv['time_start'] <= EXPERIMENT_PARAMETERS["EVALUATION_PREDICTION_END"])]
